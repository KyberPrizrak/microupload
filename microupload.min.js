...
(function(){function k(c,a){try{if("string"===typeof c){var e=document.querySelectorAll(c);for(c=0;c<e.length;c++)k(e[c],a)}else c.addEventListener("change",function(b){m(b.target.files,a)})}catch(b){}}function m(c,a){try{if("object"!==typeof a&&(a={}),"string"!==typeof a.url&&(a.url="/upload.php"),"string"!==typeof a.name&&(a.name="file"),0<a.preview_max_width||(a.preview_max_width=100),0<a.preview_max_height||(a.preview_max_height=100),"string"!==typeof a.cancel_text&&(a.cancel_text="&times;"),
"string"!==typeof a.extensions&&(a.extensions="*"),0<a.max_file_size||(a.max_file_size=0),c)for(var e=0;e<c.length;e++)n(c[e],a)}catch(b){alert("microupload error")}}function n(c,a){function e(b){if(a.onerror)a.onerror(b,c,h);d&&(d.className="microupload_item microupload_item_error")}var b=c.name.split(".");b=b[b.length-1].toLowerCase();if("*"!==a.extensions&&0>("|"+a.extensions.split(",").join("|").toLowerCase()+"|").indexOf("|"+b+"|"))e("extension");else if(0<a.max_file_size&&c.size>a.max_file_size)e("maxsize");
